...
import io.apimatic.oauthmanager.common.httpClient.headers.HttpHeaderNames;
import io.apimatic.oauthmanager.common.httpClient.headers.HttpRequestHeaders;
...
public class HttpClientHandler extends HttpMessageHandler
{
    ...
    CompletableFuture<HttpResponseMessage> sendAsync(final HttpRequestMessage request)
    {
        ...
        CompletableFuture<HttpResponseMessage> result = CompletableFuture.supplyAsync(new CompletableFuture.Generator<HttpResponseMessage>() {
            @Override
            public HttpResponseMessage get()
            {
                ...
                try
                {
                    httpsURLConnection = (HttpsURLConnection)HttpClientHandler.this.createAndPrepareHttpURLConnection(request);
                    ...
                    requestState.httpUrlConnection = httpsURLConnection;
    ...
    private void setDefaultOptions(final HttpURLConnection connection)
    {
        ...
        connection.setRequestProperty(ACCEPT_ENCODING, TextUtils.join(", ", acceptEncodings));
